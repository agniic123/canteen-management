...
<%
registration l = (registration) session.getAttribute(GlobalConstants.USER);
ArrayList<OrderMaster> orders = new UserService().getAllOrders(Integer.parseInt(l.getId()));
...
if(session.getAttribute("isLastOrdered") != null && session.getAttribute("time") != null&& l!=null){		
