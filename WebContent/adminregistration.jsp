...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between">
      <ul class="navbar-nav">
    	...
    	<li class="nav-item">
		  ...
		  <li class="nav-item">
      	  <a class="nav-link" href="LoginPage.jsp">cook registration</a>
    	</li>
  	  </ul>
...
<table  border="0" align="top" width=100%>
	...
	<form action="control?action=adminregistration"  method="post">
		    <%
	...
	<tr>
	<td bgcolor ='#C58DC4' colspan='4' align=center height=20><b>Admin information</b></td>
	</tr>
	
	<tr>
	<td>UserName</td><td>
	<input type='text' class="form-control" name='uName' id='uName 'size ='40' value=''required /></td>
	<td>&nbsp;</td><td>&nbsp;</td>
	</tr>
<tr>
	<td>Password</td><td>
	<input type="password" class="form-control" name="apass" id="apass" value='' required />
	<td>&nbsp;</td><td>&nbsp;</td>
	</tr>
	</tr>
