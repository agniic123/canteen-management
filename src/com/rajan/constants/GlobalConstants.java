...
public class GlobalConstants {
	...
	public static String JSP_PAGE = "index.html";
	...
	public static String ERROR_INVALID_CREDS_user = "Invalid UserName or password.";
	public static String ERROR_REG_ALREADY = "this registration data Already Exists.";
	public static String ERROR_REG_ALREADY_add = "user Successfully registered.";
}